...
class DataValidationConfig:
    def __init__(self, training_pipeline_config=TrainingPipelineConfig):
        ...
        # valid train and test file store in data validation artifacts 
        self.valid_train_file_path: str = os.path.join(self.valid_data_dir, training_pipeline.TRAINING_FILE_NAME)
        self.valid_test_file_path: str = os.path.join(self.valid_data_dir, training_pipeline.TEST_FILE_NAME) 
        
        # invalid train and test file store in data validation artifacts 
...
class ModelPusherConfig:
    def __init__(self, training_pipeline_config=TrainingPipelineConfig):
        ...
        self.saved_model_path = os.path.join(
            training_pipeline.SAVED_MODEL_DIR_NAME,
            f"{timestamp}",
